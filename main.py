...
.hero{margin:0 16px 18px;background:linear-gradient(135deg,#0A8EA8 0%,#0DB5D1 60%,#14D8B8 100%);border-radius:24px;padding:20px;display:flex;justify-content:space-between;align-items:center;color:#fff}
.hero h2{font-size:20px;font-weight:900;line-height:1.15}.hero p{font-size:12px;margin-top:6px}
.hero-btn{background:#fff;color:#0A8EA8;padding:12px 20px;border-radius:100px;font-weight:900;font-size:12px;cursor:pointer}
.chips{display:flex;gap:10px;overflow-x:auto;padding:0 16px 14px}.chips::-webkit-scrollbar{display:none}
.chip{white-space:nowrap;padding:12px 18px;border-radius:100px;background:#1A2035;border:1px solid var(--border);font-size:13px;font-weight:800;color:var(--muted);cursor:pointer}
.chip.active{background:#fff;color:#000;border-color:#fff}
.cats{display:flex;gap:14px;overflow-x:auto;padding:4px 16px 18px}.cats::-webkit-scrollbar{display:none}
.cat{min-width:74px;text-align:center;cursor:pointer}.cat-icon{width:70px;height:70px;background:#1A2035;border-radius:22px;display:flex;align-items:center;justify-content:center;font-size:34px;border:1px solid var(--border);margin:0 auto;overflow:hidden}
.cat-icon img{width:100%;height:100%;object-fit:cover;border-radius:22px}
.cat.active.cat-icon{border:2px solid #0A8EA8;box-shadow:0 0 0 3px rgba(10,142,168,0.3)}
...
.card-body h4{font-size:13.5px;font-weight:800;margin:4px 0 6px;height:34px;overflow:hidden}
...
.tab{flex:1;text-align:center;position:relative;cursor:pointer}.tab-i{font-size:26px}.tab b{font-size:10.5px;display:block;margin-top:3px;font-weight:700}.tab.active{color:#0A8EA8}
...
#ai{position:fixed;bottom:92px;right:16px;width:64px;height:64px;background:#0A8EA8;border-radius:20px;display:flex;align-items:center;justify-content:center;font-size:32px;color:#fff;box-shadow:0 12px 28px rgba(10,142,168,0.5);z-index:55;cursor:pointer}
...
<div class="hero"><div><h2>Free Delivery<br>on First 3 Orders!</h2><p>Use code LONMA30 • Fresh Groceries</p></div><div class="hero-btn" onclick="orderNow()">ORDER NOW</div></div>
